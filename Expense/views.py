...
def create(request):
    try:
        ...
        endLong = ""
        travelDistance = ""
        if 'startLat' in request.data:
            startLat = request.data['startLat']
            startLong = request.data['startLong']
            endLat = request.data['endLat']
            endLong = request.data['endLong']
            travelDistance = request.data['travelDistance']
        
        
        model = Expense(remarks=remarks, trip_name=trip_name, type_of_expense=type_of_expense, expense_from=expense_from, expense_to=expense_to, totalAmount=totalAmount, createDate=createDate, createTime=createTime, createdBy=createdBy, employeeId = employeeId, startLat = startLat, startLong = startLong, endLat = endLat, endLong = endLong, travelDistance = travelDistance, tripId = tripId)
...
def update(request):
    try:
        ...
        model.tripId = request.data['tripId']
