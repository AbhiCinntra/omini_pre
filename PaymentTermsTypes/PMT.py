...
# if True:
try:
	settings.custome_error_logs('cron start', module_name='pmt')
	...
	for i in range(count):
		...
		skip = skip + 20
	# endfor
	settings.custome_error_logs('cron end', module_name='pmt')
except Exception as e:
    print("Exception: ", str(e))
    settings.custome_error_logs(message=str(e), module_name='pmt')
