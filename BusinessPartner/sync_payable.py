...
# print("<><><><><><><><><><><>><><><><><><")
# print("===== Login SAP ====")
# RG_Industries_Live_", "UserName": "manager", "Password": "RG@123456", "SessionId": "a8e91956-7c8c-11ee-8000-0a427ed74412", "at": "2023-11-06 15:40:06", "sapurl": "https://103.190.95.182:50000/b1s/v1" }
# r = requests.post(data['sapurl']+'/Login', data=json.dumps(data), verify=False)
# print(r)

CronUpdateCount = 0
mycursor.execute("SELECT * FROM `BusinessPartner_payable` ORDER BY `id` desc LIMIT 1")
...
if True:
    ...
    sapAPIUrl = f"http://103.107.67.172:8000/Ledure/Report/PurchaseAging.xsjs"
    # print(sapAPIUrl)
    ...
    # print("Length of objects", len(opts['AGING']['0']))
    for opt in opts['AGING']['0']:
        ...
        U_U_UTL_Zone    = str(opt['U_U_UTL_Zone'])
        ...
        GSTIN           = str(opt['GSTIN'])
        MobileNo        = str(opt['MobileNo']).replace('"','')
