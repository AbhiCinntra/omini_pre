        ...
        if BusinessPartner.objects.filter(CardCode = CardCode).exists():
            ...
            if len(entryObjs) > 0:
                for obj in entryObjs:
                    ...
                    # if str(entObj.U_Cancel) == "N" and str(entObj.U_InterTransaction) == "N":
                    if True:
                        docId = 0
                        ...
                        entry = { "id": JdtNum, "JdtNum": JdtNum, "DocType": DocType, "Original": Original, "OriginalJournal": OriginalJournal, "DocId": docId, "Debit": obj.Debit, "Credit": obj.Credit, "Balance": round(ClosingBalance, 2), "DueDate": obj.ReferenceDate1, "Reference1": obj.Reference1, "EntryType": unquote(obj.LineMemo), "AccountName": obj.AccountName, "Reference2": obj.Reference2, "BPLName": BPLName, "Address": Address, "State": State, "TaxIdNum": TaxIdNum, "Branch_GSTIN": FederalTaxID}
