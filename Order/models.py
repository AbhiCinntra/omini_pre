...
class Order(models.Model):
    ...
    ContactPersonCode= models.CharField(max_length=50, blank=True)
    DiscountPercent  = models.CharField(max_length=50, blank=True)
    ...
    DocEntry         = models.CharField(max_length=50, blank=True)
    DocNum           = models.CharField(max_length=50, blank=True)
    ...
    FreeDelivery     = models.CharField(max_length=20, blank=True, default=0)
    CreatedBy        = models.CharField(max_length=50, blank=True, default=0)
...
class DocumentLines(models.Model):
    ...
    # new keys
    Price           = models.CharField(max_length=100, blank=True, default=0)
    PriceAfterVAT   = models.CharField(max_length=100, blank=True, default=0)
