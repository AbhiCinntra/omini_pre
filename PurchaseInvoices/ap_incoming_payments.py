...
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
try:
    settings.custome_error_logs('cron start', module_name='ap_incoming_payments')
    ...
    # endWhile
    settings.custome_error_logs('cron end', module_name='ap_incoming_payments')
except Exception as e:
    print(str(e))
    settings.custome_error_logs(message=str(e), module_name='ap_incoming_payments')