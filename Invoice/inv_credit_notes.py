...
# >>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
try:
    settings.custome_error_logs('cron start', module_name='inv_credit_notes')
    ...
    while skip != "": 
        ...
        #print("skip", skip)
    # endwhile
    settings.custome_error_logs('cron end', module_name='inv_credit_notes')
except Exception as e:
    print(str(e))
    settings.custome_error_logs(message=str(e), module_name='inv_credit_notes')