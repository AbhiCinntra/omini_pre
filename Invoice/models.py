...
class Invoice(models.Model):
    ...
    PaymentGroupCode    = models.CharField(max_length=200, blank=True, default=1)
    Series              = models.CharField(max_length=200, blank=True, default='241')
    CancelStatus        = models.CharField(max_length=200, blank=True, default='csNo')
    #add extra data
...
class DocumentLines(models.Model):
    ...
    # new key
    U_UTL_DIST      = models.CharField(max_length=200, blank=True, default="")
    U_UTL_SP        = models.CharField(max_length=200, blank=True, default="")
    U_UTL_DD        = models.CharField(max_length=200, blank=True, default="")
    U_UTL_SD        = models.CharField(max_length=200, blank=True, default="")
    U_UTL_TD        = models.CharField(max_length=200, blank=True, default="")
    U_UTL_MRPI      = models.CharField(max_length=200, blank=True, default="")
    U_RateType      = models.CharField(max_length=200, blank=True, default="")
    MeasureUnit     = models.CharField(max_length=200, blank=True, default="")
    SACEntry        = models.CharField(max_length=200, blank=True, default="")
    HSNEntry        = models.CharField(max_length=200, blank=True, default="")
